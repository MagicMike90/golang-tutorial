...
// container/heap package requires that you implement the container/heap.Interface
...
func main() {
	...
	fmt.Printf("Heap size: %d\n", len(*myHeap))
	fmt.Printf("%v\n", myHeap)
	// get properly re-sorted
	heap.Init(myHeap)
	//  a heap is a tree-not a linear structure like an array or a slice.
	fmt.Printf("%v\n", myHeap)
}
